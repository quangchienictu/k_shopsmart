<?php
  ...
  function user_rows($user_name, $pass, $name, $phone, $address){
    echo "<tr>
            ...
            <td>
              <form method='post'>
                <button type='submit' class='btn-control' class='btn-control' name='edit' value='$user_name'><i class='fa fa-edit'></i></button>
                <button type='submit' class='btn-control' class='btn-control' name='delete' value='$user_name'><i class='fa fa-trash'></i></button>
            </form>
            </td>
          </tr>";
  }
