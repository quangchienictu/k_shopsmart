...
<head>
  ...
  <!-- CSS Files -->
  <link href="../admin/assets/css/material-dashboard.css?v=2.35" rel="stylesheet" />
...
<!--   Core JS Files   -->
  ...
  <script src="../admin/assets/js/material-dashboard.js?v=2.2" type="text/javascript"></script>
